...
from CNN_model import deep_CNN, losses, trainning, evaluation
...
# 获取批次batch
train_dir = '/home/perfuser/Tensorflow-Tutorial-master/tutorial-contents/PERF_data/data'  # 训练样本的读入路径
logs_train_dir = '/home/perfuser/Tensorflow-Tutorial-master/tutorial-contents/PERF_data/code/CNN//logs'  #logs存储路径
...
try:
    ...
    for step in np.arange(MAX_STEP):
        ...
        # 每隔100步，保存一次训练好的模型
        if tra_acc == 1:
            checkpoint_path = os.path.join(model_dir, './CNN_model.ckpt')
